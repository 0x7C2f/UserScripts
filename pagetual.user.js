...
// @updateURL    https://raw.githubusercontent.com/0x7C2f/UserScripts/main/pagetual.user.js
// @downloadURL  https://raw.githubusercontent.com/0x7C2f/UserScripts/main/pagetual.user.js
// @connect      wedata.net
...
(function() {
    ...
    class RuleParser {
        ...
        getPage(doc){
            ...
            let video=document.querySelector("video,iframe[src*=player],iframe[src*=m3u8]");
            if(video){
    ...
    const pageTextStyle=`padding: unset;border: none;background: unset!important;line-height: 30px;text-decoration: none;user-select: none;visibility: visible;position: initial;width: auto;max-width: 80%; white-space: nowrap; text-overflow: ellipsis;overflow: hidden;height: auto;float: none;clear: both;margin: 0px;text-align: center;display: inline-block;font-weight: bold;font-style: normal;font-size: 16px;letter-spacing: initial;vertical-align: top;color: rgb(85, 85, 95)!important;`;
