...
(function () {
    ...
    var menu_ALL = [
            [
                'menu_disable',
                '✅ Enabled (Click to disable for this website)',
                '❌ Disabled (Click to enable for this website)',
                [],
            ],
            [
                'menu_runDuringTheDay',
                'Keep on during the day (Slightly brighter than night)',
                'Keep on during the day',
                true,
            ],
            [
                'menu_darkModeAuto',
                'Eye protection mode follows the browser',
                'Eye protection mode follows the browser',
                false,
            ],
            [
                'menu_autoRecognition',
                'Intelligent exclusion of websites with built-in dark mode (beta)',
                'Intelligent exclusion of websites with built-in dark mode (beta)',
                true,
            ],
            [
                'menu_forcedToEnable',
                '✅ Forced eye protection mode on for this website (👆)',
                '❌ Not forced eye protection mode on for this website (👆)',
                [],
            ],
            [
                'menu_darkModeType',
            ...
            [
                'menu_customTime',
                'Customize day and night time',
                'Customize day and night time',
                '6:00|18:00',
            ],
            [
                'menu_autoSwitch',
                'Automatically switch mode at night',
                'Automatically switch mode at night',
                '',
            ],
        ],
...
* {font-weight: bold !important;}`;
        ...
        if (document.lastElementChild) {
            document.lastElementChild.appendChild(style_Add).textContent =
                style;
        } else {
                ...
                setTimeout(function () {
                    ...
                    if (
                        ...
                        (getColorValue(document.lastElementChild) > 0 &&
                            getColorValue(document.lastElementChild) <
                                898989) ||
                        (window.getComputedStyle(document.body)
                            .backgroundColor === 'rgba(0, 0, 0, 0)' &&
                            window.getComputedStyle(document.lastElementChild)
                ...
                setTimeout(function () {
                    ...
                    if (
                        ...
                        if (menu_value('menu_autoRecognition')) {
                            ...
                            if (document.getElementById('XIU2DarkMode'))
                                document
                                    .getElementById('XIU2DarkMode')
                                    .remove();
                            if (document.getElementById('XIU2DarkMode2'))
                                document
                                    .getElementById('XIU2DarkMode2')
                                    .remove();
                        }
                    }
                }, 1500);
